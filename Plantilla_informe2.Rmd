...
# Introducción {#PrInv}
>>>>>>> f05159c9c06948b31613a5f5c0053ac73f822f05
...
knitr::kable(variables)%>%
 ...
 column_spec(1, bold = TRUE)  %>% # Ancho específico para variable
  footnote(general = "Tabla 1. Definición de variables principales en la base de datos ohlung.shp.", 
           general_title = "")
...
knitr::kable(head(ohlung_subset1),
  ...
  footnote(general = "Tabla 2. Primeros 6 datos de la base de datos original.", 
           general_title = "")
...
knitr::kable(
  ...
  booktabs = TRUE,
  longtable = TRUE,
  label = "tab:desc-stats"  # Etiqueta personalizada
) %>%
  kable_styling(
    latex_options = c("striped", "scale_down"), 
    font_size = 9,  
  ...
  footnote(general = "Tabla 3. Estadísticas descriptivas de casos y población.", 
           general_title = "")
```
...
A su vez se observa que las variables geográficas aportan información limitada a la hora de explicar el comportamiento de cualquera de las variables aya sea de numero de casos o de población en riesgo de cáncer pulmonar.
...
```{r boxplots, echo=FALSE, fig.height=4, fig.width=3.5, message=FALSE, warning=FALSE}
...
Se observa una precencia de datos atípicos por años, mas dispersión conforme pasan los años, sin embargo la media parece mantenerse.Más dispersos en hombres que mujeres pero media constante, más datos atípicos por hombres que por mujeres.

<<<<<<< HEAD
```{r scatterplot, echo=FALSE, fig.height=4, fig.width=7, message=FALSE, warning=FALSE}
plot(ohlung_long$cases, col = ohlung_long$gender, pch = 16, xlab = "Número de casos", ylab = "Género", main = "Dispersión de casos por género") 

```

=======
```{r scatterplot, echo=FALSE, fig.height=4.5, fig.width=7, message=FALSE, warning=FALSE}
plot(ohlung_long$cases, col = ohlung_long$gender, pch = 16, xlab = "Número de casos", ylab = "Género", main = "Dispersión de casos por género")
```
