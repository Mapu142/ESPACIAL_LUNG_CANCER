...
```{r boxplots, echo=FALSE, fig.height=4, fig.width=5, message=FALSE, warning=FALSE}
...
```{r scatterplot, echo=FALSE, fig.height=4.5, fig.width=8, message=FALSE, warning=FALSE}
