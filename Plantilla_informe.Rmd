...
```{r boxplots, echo=FALSE, fig.height=5, fig.width=7, message=FALSE, warning=FALSE}
...
```{r scarettplot, echo=FALSE, fig.height=5, fig.width=10, message=FALSE, warning=FALSE}
