...
# Análisis descriptivo {#AnalisisDescriptivo} 
 ...
 A continuación se presenta una muestra representativa de la estructura de los datos. Por razones de espacio y legibilidad, se muestran únicamente las variables de identificación del condado y un subconjunto de las variables de mortalidad (agrupadas por década) que ilustran el patrón de codificación del conjunto de datos. 
